...
#include <communicate/eventDispatcher/eventHandler/event_handler.h>
...
public:
	...
	{
		boost::lock_guard<boost::mutex> lock(mapLocker_);
	...
	void removeListeners(unsigned int eventType)
	{
		...
		boost::lock_guard<std::mutex> guard(mapLocker_);
