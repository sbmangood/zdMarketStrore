...
bool Endpoint::bind(boost::shared_ptr<IChannel> chananel, callbackHandler callFun)
{
	if (!chananel)
	{
		return false;
...
int Endpoint::handlerMsgDecoded(unsigned int eventid, EventDispatcher< const boost::any& > & endpoint, const boost::any& msg)
{
...
void Endpoint::send_msg(const boost::any& msg)
{
	if (chnanel_)
	{
